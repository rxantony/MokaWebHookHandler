...
@Component
public class CreateProduct implements RequestHandler<CreateProductRequest, Boolean>{

    private final JdbcTemplate jdbcTemplate;
    private static final Logger LOGGER = LogManager.getFormatterLogger(CreateProduct.class);
    private static final String INSERT_ITEM_SQL = "INSERT INTO item (id, name, description, created_at, updated_at) VALUES (?,?,?,?,?)";
    
    public CreateProduct(@Qualifier("mokaaddons") DataSource dataSource) {
