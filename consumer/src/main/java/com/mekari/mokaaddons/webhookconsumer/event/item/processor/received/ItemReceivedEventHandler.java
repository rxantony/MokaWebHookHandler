...
@Service
public class ItemReceivedEventHandler extends AbstractVoidRequestHandler<HandleItemReceivedEventRequest> {
    
    private AmqpTemplate amqpTemplate;
    private RequestHandlerManager handlerManager;

    public ItemReceivedEventHandler(@Autowired RequestHandlerManager handlerManager, @Autowired AmqpTemplate amqpTemplate){
        this.handlerManager = handlerManager;
        this.amqpTemplate = amqpTemplate;
    }

    @Override
    protected void handleInternal(HandleItemReceivedEventRequest request) throws Exception {
